...
**KH: The larger bin size plots hide the fact that the majority of flights actually have a slight delay, which is easily visible in the smallest bin size plot.**
...
**KH: The distribution of arrival delays (`arr_delay`) is unimodal and right skewed. Due to the skewness, we will prefer the *median* (-5 min) and *IQR* (31 min) as measures of central tendency, as these measures are less sensitive to skew than mean / standard deviation.**
```{r e_3}
...
**The median, in contrast, is robust to skewness and outliers, and would be a better choice if the departure delays are not normally distributed.**
...
**KH: I would choose LGA as it has the highest rate of on-time departures.**
