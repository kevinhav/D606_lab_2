...
**The large bin size plot hides the fact that the majority of flights actually have a slight delay, which is easily visible once the bin size is reduced.**
...
**The distribution of arrival delays (`arr_delay`) is unimodal and right skewed. Due to the skewness, we will prefer the *median* (-5 min) and *IQR* (31 min) as measures of central tendency.**
```{r}
...
**I would choose LGA as it has the high rate of on-time departures.**
